...
<div class="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl shadow-slate-200 w-full max-w-2xl border border-slate-50">
    <header class="text-center mb-8">
        <a href="/api/admin_dashboard.php" class="inline-block mb-4 text-[10px] font-black text-blue-600 uppercase tracking-widest bg-blue-50 px-4 py-2 rounded-full hover:bg-blue-100 transition-colors">
            ← Kembali ke Panel
        </a>
    ...
    <form method="POST" action="/api/proses_tambah_admin.php" class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <button class="md:col-span-2 w-full bg-slate-900 text-white p-5 rounded-[2rem] font-black text-[11px] uppercase tracking-[0.2em] hover:bg-blue-600 shadow-xl shadow-slate-100 transition-all active:scale-95">
