...
<div class="flex justify-center items-center flex-grow p-6">
    <div class="bg-white/90 backdrop-blur-md border border-slate-100 p-8 md:p-10 rounded-[3rem] shadow-2xl shadow-green-900/5 w-full max-w-lg">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 font-medium mt-2">Daftar untuk akses layanan digital</p>
        </div>
        ...
        <form method="POST" action="proses_register.php" onsubmit="return validasi()" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="md:col-span-2">
                ...
                <input type="email" name="email" id="email" required placeholder="nama@email.com" class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-green-100 outline-none font-medium text-slate-700 transition-all">
            </div>

            <div class="md:col-span-2">
                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Nama Lengkap</label>
                <input type="text" name="nama" required placeholder="Sesuai KTP" class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-green-100 outline-none font-medium text-slate-700 transition-all">
            </div>

            <div>
                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">NIK</label>
                <input type="text" name="nik" id="nik" required placeholder="16 Digit" class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-green-100 outline-none font-mono text-sm transition-all">
            </div>

            <div>
                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">WhatsApp</label>
                <input type="text" name="no_hp" required placeholder="0812..." class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-green-100 outline-none font-medium transition-all">
            </div>

            <div class="md:col-span-2">
                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Domisili</label>
                <textarea name="alamat" required placeholder="Alamat lengkap..." rows="2" class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-green-100 outline-none font-medium transition-all resize-none"></textarea>
            </div>

            <div class="md:col-span-2 relative">
                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1 text-green-600">Password</label>
                <input type="password" name="password" id="password" required placeholder="Min. 8 Karakter" class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-green-100 outline-none font-medium transition-all">
        ...
        <div class="mt-8 pt-6 border-t border-slate-50 text-center">
            <p class="text-sm font-medium text-slate-500">Sudah punya akun? <a href="login.php" class="text-green-600 font-bold hover:underline">Login di sini</a></p>
        </div>
    </div>
</div>
