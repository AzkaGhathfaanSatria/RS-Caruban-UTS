...
<div class="max-w-4xl mx-auto p-4 md:p-8 w-full flex-1">
    ...
    <div class="mb-8">
        <a href="/api/dashboard.php" class="inline-flex items-center gap-2 text-slate-500 hover:text-blue-600 transition-all font-bold text-sm">
    ...
    <div class="bg-white border border-slate-100 rounded-[2.5rem] shadow-2xl shadow-blue-900/5 overflow-hidden">
        ...
        <div class="p-8 md:p-12">
            <header class="mb-10">
                ...
                <p class="text-slate-500 font-medium text-sm">Lengkapi formulir untuk pendaftaran poliklinik.</p>
            </header>

            <form method="POST" action="/api/proses_pendaftaran.php" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-100 transition-all outline-none font-medium">
                    </div>
                    ...
                    <div>
                        ...
                        class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-100 transition-all outline-none font-mono">
                    </div>
                ...
                <div class="pt-8">
                    <button type="submit" class="w-full bg-slate-900 text-white p-5 rounded-2xl font-black text-sm uppercase tracking-[0.2em] hover:bg-blue-600 transition-all shadow-xl active:scale-95 flex items-center justify-center gap-3">
