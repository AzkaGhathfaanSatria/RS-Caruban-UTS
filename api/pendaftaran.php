            ...
            <form method="POST" action="proses_pendaftaran.php" class="space-y-5 md:space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div>
                        ...
                        <input type="text" name="nama" required value="<?= $nama_default ?>" placeholder="Nama Lengkap" class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-100 transition-all outline-none font-medium text-sm">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5 ml-1">NIK (16 Digit)</label>
                        <input type="text" name="nik" required inputmode="numeric" value="<?= $nik_default ?>" placeholder="NIK Pasien" class="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-100 transition-all outline-none font-mono text-sm">
                    </div>
